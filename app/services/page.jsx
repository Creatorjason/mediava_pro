...
const tools = [
  ...
  },
  {
    ...
    image: "/reg.jpg",
    link: "/services/cre-registration",
    comingSoon: true // Add comingSoon property here
  },
  {
    title: "creLaundry",
      ...
      <div className="min-h-screen bg-gradient-to-b from-gray-800 to-black text-white">
        ...
        <div className="mb-8 flex justify-center">
            <input
              ...
              className="px-4 py-2 rounded-md text-black w-full max-w-md focus:outline-none focus:ring-2 focus:ring-cyan-500"
            />
          </div>
